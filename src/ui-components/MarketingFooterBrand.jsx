  ...
  return (
    ...
    >
      <Flex
        ...
        {...getOverrideProps(overrides, "Frame 4053979651")}
      >
        <Flex
          gap="8px"
          direction="column"
        ...
        >
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children="ASU's Smart City Cloud Innovation Center Powered by AWS"
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children="A global solution platforms to solve pressing community and regional challenges"
        ...
        <Flex
          ...
          position="relative"
          padding="0px 20px 0px 20px"
          {...getOverrideProps(overrides, "Frame 4053979664")}
        >
          <Text
            fontFamily="Inter"
            fontSize="16px"
      ...
      >
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="© 2023 Smart City Cloud Innovation Center Project Showcase. All rights reserved."
          {...getOverrideProps(
            overrides,
